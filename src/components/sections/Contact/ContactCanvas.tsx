// src/components/sections/Contact/ContactCanvas.tsx
'use client';
...
export default function ContactCanvas() {
  return (
    <Scene className="absolute inset-0">
      ...
      {/* Glass orbs */}
      <GlassOrb position={[5, 2, -4]} scale={0.8} speed={0.5} color="#8b5cf6" />
      <GlassOrb position={[-5, -2, -3]} scale={0.6} speed={0.7} color="#00d9ff" />
      <GlassOrb position={[0, 0, -5]} scale={1} speed={0.4} color="#ec4899" />
