// src/components/sections/About/AboutCanvas.tsx
'use client';
...
export default function AboutCanvas() {
  return (
    <Scene className="absolute inset-0">
      ...
      {/* Glass orbs positioned differently than Hero */}
      <GlassOrb position={[-5, 3, -4]} scale={0.8} speed={0.5} color="#8b5cf6" />
      <GlassOrb position={[3, -2, -3]} scale={1} speed={0.7} color="#00d9ff" />
      <GlassOrb position={[-2, 1, -2]} scale={0.6} speed={0.9} color="#06b6d4" />
      <GlassOrb position={[4, 2, -3.5]} scale={0.7} speed={0.6} color="#a855f7" />
